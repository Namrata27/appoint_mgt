        ...
        <section class="sidebar">
          ...
          <div class="user-panel">
            ...
            <div class="pull-left info">
              ...
              <?php if($_SESSION['menu'] == 'short'){ 
              	 $showhidelink = 'hidelink';
              	
              	?>
              <a href="<?php echo $_SERVER['REQUEST_URI'] ?>&menu=full"><i class="fa fa-circle text-success"></i> Show Full Menu</a>
			  <?php } elseif($_SESSION['menu'] == 'full'){ 
			  	$showhidelink = '';
			  	?>
			  <a href="<?php echo $_SERVER['REQUEST_URI'] ?>&menu=short"><i class="fa fa-circle text-success"></i> Show Short Menu</a>	
			  <?php } else { 
			  	$showhidelink = 'hidelink';
			  	?>
			 <a href="<?php echo $_SERVER['REQUEST_URI'] ?>&menu=full"><i class="fa fa-circle text-success"></i> Show Full Menu</a>	
          ...
          <form action="#" method="get" class="sidebar-form">
            <div class="input-group">
              <input type="text" id="global_search" name="q" class="form-control" placeholder="Search..."/>
